...
**Version incluse :** 2.35.0~ynh1 *(:warning: Il s'agit de la branche `ci-auto-update-v2.35.0`. La [branche `master`](https://github.com/YunoHost-Apps/dex_ynh/tree/master) utilisée dans le catalogue est actuellement en 2.34.0\~ynh1.)*
